...
function mapInitError() {
  document.getElementById('loading-ajax').style.display = "none";
  showDialog({
    title: 'Failed to load Google Map',
    text: 'Sorry, but Google Map seems to be temporary unavailable.<br>Please reload this page later.',
    negative: {
      title: 'Close'
    }
  });
  console.log('Sorry, but Google Map seems to be temporary unavailable.Please reload this page later.');
}
